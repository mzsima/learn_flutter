...
class ExampleCupertinoDownloadButton extends StatefulWidget {
  ...
  @override
  _ExampleCupertinoDownloadButton createState() => _ExampleCupertinoDownloadButton();
}

class _ExampleCupertinoDownloadButton extends State<ExampleCupertinoDownloadButton> {
...
class SimulatedDownloadController extends DownloadController with ChangeNotifier {
  ...
  Future<void> _doSimulatedDownload() async {
    ...
    const downloadPrograssStops = [0.0, 0.15, 0.45, 0.80, 1.0];
    for (final stop in downloadPrograssStops) {
      await Future<void>.delayed(const Duration(seconds: 1));
